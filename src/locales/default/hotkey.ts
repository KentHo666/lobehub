export default {
  ...
  'desktop.showApp.desc': 'Open the desktop mini toolbar with a global shortcut',
  'desktop.showApp.title': 'Open Mini Toolbar',
  ...
  'search.title': 'Search',
  'showApp.desc': 'Quickly open the desktop mini toolbar',
  'showApp.title': 'Open Mini Toolbar',
  'switchAgent.desc':

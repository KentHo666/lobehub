export default {
  ...
  'agentWorkingSidebar.progress': 'Progress',
  'agentWorkingSidebar.progress.allCompleted': 'All tasks completed',
  'agentWorkingSidebar.resources': 'Resources',
  'agentWorkingSidebar.resources.deleteConfirm': 'This action cannot be undone.',
  'agentWorkingSidebar.resources.deleteError': 'Failed to delete document',
  'agentWorkingSidebar.resources.deleteSuccess': 'Document deleted',
  'agentWorkingSidebar.resources.deleteTitle': 'Delete document?',
  ...
  'agentWorkingSidebar.resources.renameEmpty': 'Title cannot be empty',
  'agentWorkingSidebar.resources.renameError': 'Failed to rename document',
  'agentWorkingSidebar.resources.renameSuccess': 'Document renamed',
  'agentWorkingSidebar.documents.close': 'Close',
  'agentWorkingSidebar.documents.error': 'Failed to load document',
  'agentWorkingSidebar.documents.loading': 'Loading document...',
  'agentWorkingSidebar.documents.discard': 'Discard',
  'agentWorkingSidebar.documents.preview': 'Preview',
  'agentWorkingSidebar.documents.edit': 'Edit',
  'agentWorkingSidebar.documents.save': 'Save',
  'agentWorkingSidebar.documents.saved': 'All changes saved',
  'agentWorkingSidebar.documents.title': 'Document',
  'agentWorkingSidebar.documents.unsaved': 'Unsaved changes',
  'agentWorkingSidebar.title': 'Agent Workspace',
  'you': 'You',
  'zenMode': 'Zen Mode',
};

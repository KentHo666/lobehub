export default {
  ...
  'pageEditor.history.compareCurrentLabel': 'Current v{{version}}',
  'pageEditor.history.compareDescription':
    'Comparing against the current head version v{{version}}',
  'pageEditor.history.compareError': 'Failed to load diff preview',
  'pageEditor.history.compareModalTitle': 'Compare v{{version}}',
  ...
  'pageEditor.history.restoreError': 'Failed to restore this version',
  'pageEditor.history.restoreConfirm.content':
    'Restore version v{{version}} saved on {{savedAt}}? This will create a new current version.',
  'pageEditor.history.restoreConfirm.title': 'Restore v{{version}}',
  ...
  'pageEditor.history.versionLabel': 'History v{{version}}',
